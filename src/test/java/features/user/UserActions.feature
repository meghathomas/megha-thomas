Feature: User Actions - create new user, view & update existing user information and delete the user

  Scenario Outline: Create new user & view, update, delete the created user
